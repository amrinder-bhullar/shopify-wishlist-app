<div x-data="{ open: true, progress: false }" x-show="open" class="relative z-10" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    <!--
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    "
                        ...
                        <span class="px-2" x-show="progress">@include('partials.spinner')</span> Configure</button>
